...
public class AlphaSlideBar extends AbstractSlider {
    ...
    public void updatePaint(Paint colorPaint) {
        ...
        Shader shader = new LinearGradient(0, 0, getMeasuredWidth(), getMeasuredHeight(), startColor, endColor, Shader.TileMode.CLAMP);
    ...
    public void onInflateFinished() {
        ...
        if (getPreferenceName() != null) {
            updateSelectorX(ColorPickerPreferenceManager.getInstance(getContext()).getAlphaSliderPosition(getPreferenceName(), defaultPosition) + getSelectorSize());
        } else {
